...
def build_parser():
    ...
    parser.add_argument('--original_gui_filepath', type=str,
                        dest='original_gui_filepath', help='if getting BLEU score, provide original gui filepath',
                        default=None)
...
def main():
    ...
    sampler.convert_single_image(output_folder, png_path=png_path, print_generated_output=print_generated_output,
